...
#Plot the measurement outcomes at each valu in the sweep
angles = [x[0][1] for x in sweep.param_tuples()]
zeroes = [res[i].histogram(key='z')[0] / 100 for i in range(len(res))]
...
plt.savefig("Quantumparam-sweep-cirq.pdf", format="pdf")